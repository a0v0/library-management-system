const books = [
  ...
  },
  {
    ...
    popular: true,
    new: false,
    description: "A classic adventure in Middle-earth.",
  },
  {
    title: "Dune",
  ...
  },
  {
    ...
    popular: false,
    new: true,
    description: "The fall and rise of a galactic empire.",
  },
  {
    ...
    popular: true,
    new: false,
    description: "A hacker and journalist uncover dark secrets.",
  },
  {
    title: "Gone Girl",
    ...
    popular: true,
    new: false,
    description: "A twisted tale of marriage and disappearance.",
  },
  {
    title: "Sapiens",
  ...
  },
  {
    ...
    popular: true,
    new: false,
    description: "A former First Lady’s memoir.",
  },
  {
  ...
  },
  {
    ...
    popular: false,
    new: true,
    description: "Writers swap genres and find love.",
  },
  {
    ...
    popular: true,
    new: false,
    description: "A story of love and resilience.",
  },
];
...
function loadUserFromLocalStorage() {
  ...
  borrowedBooks =
    JSON.parse(localStorage.getItem("borrowedBooks")) || borrowedBooks;
...
async function handleLogin(event) {
  ...
  if (process.env.NODE_ENV === "development") {
    console.log("Sending request:", { ...loginData, password: "****" });
  }
    ...
    navHTML += `
            ...
            <div class="flex items-center space-x-2">
                <div class="flex items-center space-x-2 cursor-pointer" onclick="showProfile()">
                    ...
                    <span class="text-white hover:text-blue-200 transition font-semibold">${
                      user.username
                    }</span>
                </div>
...
function loadAdminDashboard() {
  ...
  if (document.getElementById("issued-books"))
    document.getElementById("issued-books").textContent = issuedBooks;
  if (document.getElementById("available-books"))
...
function loadUserDashboard() {
  ...
  if (wishlistDiv) {
    wishlistDiv.innerHTML = user.wishlist.length
      ? user.wishlist.map((w) => `<p>${w}</p>`).join("")
