...
?>
    ...
    <body>
        ...
        <div class="w-full flex flex-col justify-center items-center pl-3 pt-30 text-center">
            <div>
                <h3 class="text-4xl font-semibold text-slate-800">Manage Issued Books</h3>
                <p class="text-slate-500">View and manage all issued books in the system.</p>
            </div>
        </div>
                ...
                <div class="w-full max-w-sm min-w-[200px] relative">
                    <div class="relative">
                        <input
                            ...
                            placeholder="Search for issued books..."
                            onkeyup="filterTable()" />
                        <button
                        ...
                        if ($query->rowCount() > 0) {
                            foreach ($results as $result) { ?>
                                <tr class="hover:bg-slate-50 border-b border-slate-200">
                                    ...
                                    <td class="p-4 py-5 border border-slate-200"><?php echo htmlentities(date("F j, Y, g:i a", strtotime($result->IssuesDate))); ?></td>
                                    <td class="p-4 py-5 border border-slate-200"><?php echo htmlentities($result->ReturnDate ? date("F j, Y, g:i a", strtotime($result->ReturnDate)) : "Not Returned Yet"); ?></td>
                                    <td class="p-4 py-5 border border-slate-200">
                                        <a href="update-issue-bookdeails.php?rid=<?php echo htmlentities($result->rid); ?>" class="text-blue-500 hover:underline">Edit</a>
                                    </td>
                                </tr>
                        <?php $cnt++;
                            }
